...
Answer:
vec_numeric worked, it computed the average based on the numeric inputs. vec_char and vec_factor: You cannot calculate the mean of character or factor variables. If you attempt to calculate the mean of these types, you will get an error.
